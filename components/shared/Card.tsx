  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      ...
      <Link
        ...
        className="flex-center flex-grow bg-gray-50 h-64 bg-cover bg-center text-grey-500 "
        />
      </div>
      {/* IS EVENT CREATOR ... */}

      {isEventCreator && !hidePrice && hasOrderLink && (
      ...
      >
        ...
        <p className="p-medium-12 p-medium-14  text-grey-500 line-clamp-2">
          {event.description}
        </p>
        </Link>
        ...
        <div className="flex-between w-full">
          <p className="p-medium-14 md:p-medium-16 text-grey-600 font-bold line-clamp-1">
